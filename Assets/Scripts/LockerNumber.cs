...
public class LockerNumber : MonoBehaviour, IInteractable
{
    public void Interact(DisplayImage currentDisplay)
    {
        ...
        GetComponent<SpriteRenderer>().sprite = transform.parent.GetComponent<NumberLock>().numberSprites[transform.parent.GetComponent<NumberLock>().currentIndividualIndex[transform.GetSiblingIndex()]];
    }
}
